...
sudo ./alpine-make-vm-image --image-format qcow2 --image-size 10G --repositories-file alpinerepos --packages "$(cat alpinepackages)" -c virtuevm.qcow2 -- ./alpineconfigure.sh
sudo chown $USER virtuevm.qcow2
