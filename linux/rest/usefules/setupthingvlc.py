...
pc('create an app for vlc', bc.HEADER)
goodrole = json.loads(api('/application/create', {"userToken":admintok, "applicationID":"vlc", "install":"vlc", "launchCmd":"vlc", "icon":"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/VLC_Icon.svg/424px-VLC_Icon.svg.png", "type":"linux"}))
...
pc('create a role for vlc', bc.HEADER)
goodrole = json.loads(api('/role/create', {"userToken":admintok, "roleID":"vlc", "applicationIDs":["xterm", "vlc"]}))
pprint.pprint(goodrole)

pc('ok, admin will add rolo', bc.HEADER)
badv = json.loads(api('/user/role/authorize', {"userToken":admintok, "username":username, "roleID":"vlc"}))
pprint.pprint(badv)
...
while True:
	badv = json.loads(api('/role/get', {"userToken":admintok, "roleID":"vlc"}))
	pprint.pprint(badv)
...
badv = json.loads(api('/virtue/create', {"userToken":admintok, "roleID":"vlc", "userID":username}))
pprint.pprint(badv)
