...
pc('create a role for firefox', bc.HEADER)
goodrole = json.loads(api('/role/create', {"userToken":admintok, "roleID":"firefox", "applicationIDs":["firefox"]}))
pprint.pprint(goodrole)

pc('ok, admin will add rolo', bc.HEADER)
badv = json.loads(api('/user/role/authorize', {"userToken":admintok, "username":username, "roleID":"firefox"}))
pprint.pprint(badv)
...
while True:
	badv = json.loads(api('/role/get', {"userToken":admintok, "roleID":"firefox"}))
	pprint.pprint(badv)
...
badv = json.loads(api('/virtue/create', {"userToken":admintok, "userID":username, "roleID":"firefox"}))
pprint.pprint(badv)
