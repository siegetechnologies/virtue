...
#define INITGUID
#include <guiddef.h>
#include "snifferguid.h"


#define MONITOR_FLOW_ESTABLISHED_CALLOUT_DESCRIPTION L"VirtueSniffer - Flow Established Callout"
#define MONITOR_FLOW_ESTABLISHED_CALLOUT_NAME L"Flow Established Callout"

#define MONITOR_STREAM_CALLOUT_DESCRIPTION L"Virtue Sniffer - Stream Callout"
...
--*/
{
   ...
   callout.calloutKey = SNIFFER_SAMPLE_FLOW_ESTABLISHED_CALLOUT_V4;
   ...
   callout.calloutKey = SNIFFER_SAMPLE_STREAM_CALLOUT_V4;
   callout.displayData = displayData;
...
--*/
{
   ...
   result = FwpmCalloutDeleteByKey(engineHandle,
                                    &SNIFFER_SAMPLE_FLOW_ESTABLISHED_CALLOUT_V4);
   if (NO_ERROR != result)
   {
      goto abort;
   }
   ...
   result = FwpmCalloutDeleteByKey(engineHandle,
                                    &SNIFFER_SAMPLE_STREAM_CALLOUT_V4);
   if (NO_ERROR != result)
   {
      goto abort;
   }
...
--*/
{
   ...
   monitorSubLayer.subLayerKey = SNIFFER_SAMPLE_SUBLAYER;
   ...
   filter.action.calloutKey = SNIFFER_SAMPLE_FLOW_ESTABLISHED_CALLOUT_V4;
   ...
   filter.action.type = FWP_ACTION_CALLOUT_INSPECTION; // We're only doing inspection.
   filter.action.calloutKey = SNIFFER_SAMPLE_STREAM_CALLOUT_V4;
   filter.subLayerKey = monitorSubLayer.subLayerKey;
   filter.weight.type = FWP_EMPTY; // auto-weight.
