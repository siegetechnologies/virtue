...
typedef struct packet_metrics_s {
	UINT64 icmpCountInbound;
	UINT64 icmpv6CountInbound;
	UINT64 tcpCountInbound;
	UINT64 udpCountInbound;
	UINT64 icmpCountOutbound;
	UINT64 icmpv6CountOutbound;
	UINT64 tcpCountOutbound;
	UINT64 udpCountOutbound;
}packet_metrics_t;
...
/*
* Read Metrics from a WinDivert handle.
*/
extern WINDIVERTEXPORT BOOL WinDivertGetMetrics(
	__in        HANDLE handle,
	__out       PVOID pMetrics,
	__in        UINT metricsLen);
